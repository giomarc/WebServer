...
typedef struct {
	hashmap_t* map;
	void* (*key_get)( void* item);
} functor_tomap_data_t;

bool functor_tomap( void* item, void* data);
...
bool functor_toarray( void* item, void* data);
...
bool functor_totrie( void* item, void* data);

typedef struct {
	hashtable_t* set;
} functor_toset_data_t;

bool functor_toset( void* item, void* data) ;
