...
void item_free( void* item,  void* data) {
...
bool item_functor( const void* item, const void* data) {
...
bool putall_functor(const void* item, const void* data) {
...
void hashmap_clear(hashmap_t* map, coll_unduper_f* unduper, void* unduper_data) {
	...
	hashtable_clear(map->hashtable, item_free, unduper_data);
}
